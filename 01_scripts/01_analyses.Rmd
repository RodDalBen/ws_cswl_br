...
if(save_output == T){
  sjPlot::tab_model(mod_freq_ws_trials_exp1,
                  show.p = F,
                  title = "Experiment 1 - Speech segmentation as a fuction of speech version and trial number", 
                  file = here("03_output_graphics", "mod_freq_ws_trials_exp1.doc"))
}
...
if(save_output == T){
  sjPlot::tab_model(mod_freq_ws_trials_exp2,
                  show.p = F,
                  title = "Experiment 2 - Speech segmentation as a fuction of trial number", 
                  file = here("03_output_graphics", "mod_freq_ws_trials_exp2.doc"))
}
