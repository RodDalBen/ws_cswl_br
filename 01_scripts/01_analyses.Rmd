...
Data analyses for the study combining word segmentation (ws), cross-situational word learning (cswl), and phonotactics in parallel. The study was performed with Brazilian adults (both in person and online). For a full acount see the following reference.
...
#ggsave(plot = plot_perf_study1, 
#       filename = here("03_output_graphics/plot_perf_study1.png"), 
...
#ggsave(plot = plot_perf_study2, 
#       filename = here("03_output_graphics/plot_perf_study2.png"),
...
data_filtered_v2 %>% 
  ...
  labs(title = "CSWL", y = "Proportion of correct selection", x = "Speech version") + 
